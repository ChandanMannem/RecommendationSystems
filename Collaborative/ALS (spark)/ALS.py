...
if __name__ == "__main__":
	...
	error.saveAsTextFile(sys.argv[3]+"/error.txt")
	...
	resultRDD.saveAsTextFile(sys.argv[3]+"/result.txt")
	...
	user_ids_RDD.saveAsTextFile(sys.argv[3]+"/users.txt")
	...
	book_ids_RDD.saveAsTextFile(sys.argv[3]+"/books.txt")
